...
To reduce storage use, see instructions [here](etc/detailed-webserver-instructions.md#reducing-storage-use).  To customize page contents, see [here](etc/detailed-webserver-instructions.md#customizing-page-contents).
