...
const loadLocusZoom = (phenotype: string) => {
  ...
  dataSources.add("gwas_cat", ["GWASCatSoureLZ", {
    url: `${remoteBase}annotation/gwascatalog/`,
    params: { id: [1, 4], pvalue_field: "log_pvalue" }
  }]);
  dataSources.add("gene", ["GeneLZ", { url: `${remoteBase}annotation/genes/`, params: { source: 1 } }]);
  ...
  dataSources.add("clinvar", ["ClinvarDataSourceLZ", {
    url: "/api/ncbi/",
    params: { id: [1, 4], pvalue_field: "log_pvalue" }
  }]);
  ...
  Dashboard.Components.add("region", function(layout : { class : string , style : string }){
    const args : [any,any] = [null,null]
    const component  : Dashboard.Component = new Dashboard.Component.apply(this);
