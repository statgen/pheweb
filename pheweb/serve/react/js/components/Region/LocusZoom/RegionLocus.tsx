...
TransformationFunctions.set<number, number>("logneglog", function(this: any, x: number) {
...
function add_dashboard_button(name: string, func: (layout: ComponentsEntity) => { bind: (a: any) => any }) {
  Dashboard.Components.add(name, function(this: any, layout: ComponentsEntity) {
    let args : [any,any]
    Dashboard.Component.apply(this, args);
...
export const init_locus_zoom = (region: Region): LocusZoomContext => {
  ...
  dataSources.add("conditional", ["ConditionalLZ", {
    url: localCondBase,
    params: { trait_fields: ["association:pvalue", "association:beta", "association:sebeta", "association:rsid"] }
  }]);
  dataSources.add("finemapping", ["FineMappingLZ", {
    url: localFMBase,
    params: { trait_fields: ["association:pvalue", "association:beta", "association:sebeta", "association:rsid"] }
  }]);
  ...
  dataSources.add("recomb", ["RecombLZ", {
    url: `${remoteBase}annotation/recomb/results/`,
    params: { source: recombSource }
  }]);

  Dashboard.Components.add<ComponentsEntity>("region", function(this : any, layout: ComponentsEntity) {
    let arg : [any,any]
    Dashboard.Component.apply(this, arg);
    this.update = function() {
    ...
    return this as unknown as Dashboard.Component;
  });
