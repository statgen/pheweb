...
const create_qq_plot = function (maf_ranges) {

  maf_ranges.forEach(function (maf_range, i) { maf_range.color = ['#E8580C', '#D20CE8', '#FF0000', '#FFAC0D'][i] })
  ...
  $(function () {
    ...
    qq_plot.append('g')
      ...
      .attr('fill', function (d, i) {
        const parentIndex = +this.parentNode.getAttribute('data-index')
        return maf_ranges[parentIndex].color
      })
