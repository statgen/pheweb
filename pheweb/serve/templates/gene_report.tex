...
\hline
((* for var in topAssoc *))
    ((( var.variant.id.replace(":"," ") | escape_tex))) \newline ((( var.variant.rsids ))) & ((( var.assoc.phenostring | escape_tex))) & (((var.assoc.n_case ))) & (((var.assoc.n_control))) & ((( "{:.2e}".format(var.assoc.maf_case) ))) & ((( "{:.2e}".format(var.assoc.maf_control) ))) & ((( "{:.2e}".format(math.exp(var.assoc.beta)) ))) & ((( "{:.2e}".format(var.assoc.pval) ))) & (((var.ukbbdisplay)))\\
((* endfor *))
\end{longtable}
\end{landscape}
