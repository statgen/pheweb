...
def set_override(key:str, value:Any) -> None:
    ...
    if key=='download_top_hits' and value=='hide':
        overrides['hidden_download_top_hits_button'] = True
    if key=='download_phenotypes' and value=='hide':
        overrides['hidden_download_phenotypes_button'] = True
    elif key == 'login':
...
def is_hidden_download_top_hits_button() -> bool: return _get_config_bool('hidden_download_top_hits_button', False)
def is_hidden_download_phenotypes_button() -> bool: return _get_config_bool('hidden_download_phenotypes_button', False)
